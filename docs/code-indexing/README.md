...
| [Ruby](languages/ruby.md)             | tree-sitter | `.rb` `.rake` `.gemspec`                     |                                        Module, Class, Method                                         |      call routing (require/include/attr\_\*)      | require, require_relative |        superclass, mixins         |                --                |
...
| [Performance](cobol/performance.md)           | PROJECT-NAME benchmarks, tuning, known limitations, troubleshooting    |
