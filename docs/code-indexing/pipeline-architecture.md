...
For a 224 MB codebase (e.g., PROJECT-NAME COBOL), this produces approximately 12 chunks.
...
| **Typical load time** | ~132s for 2.8M nodes (PROJECT-NAME)                       | ~35-60s for 177K nodes via HTTP                        |
